...
public class textInput
{
   ...
   //Purpose: Need to construct a default textInput object
   //assumptions: None
   //inputs: None 
   //post conditions: A default textInput object has been created  
   public textInput()
   {
      this.fileName = "A Dream Within a Dream.txt";
