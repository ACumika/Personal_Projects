...
Serial.println("LABEL, TimeElappsed, TempHot, TempCold, VoltageR, DeltaT, Current mA, Seebeck");
...
//float tempF=((tempC*9/5)+32); //Convert to Fahrenheit 
 ...
 float DeltaT=tempChot-tempCcold;
 float Seebeck=voltagetotal/DeltaT;
 ...
 float currentmA=(voltagetotal/10000)*1000;
